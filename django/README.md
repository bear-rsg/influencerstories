# Influencer Stories of Mental Health and Young People - Django Project
...
The project is called 'influencerstories', but project files are stored in the 'core' folder. Please refer to `core/settings.py` for further details
