...
ALLOWED_HOSTS = ['*']/['influencerstories.bham.ac.uk']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'influencerstories.sqlite3'),
        'TEST': {
            'NAME': os.path.join(BASE_DIR, 'influencerstories_TEST.sqlite3'),
        },
    }
}
